...
- Proof date: 2026-08-30
- Google Cloud project: `project-c0f0f832-e02b-4eac-ae2`
- Transaction-plane region: `us-central1`
- Vertex inference location: `global`
- Accepted application release commit: `582df1f`
- Public Command Center: <https://veritas-preview-web-602044424209.us-central1.run.app/>
- Cloud Build: `0e381867-45fd-4ccf-892c-a54741a1b2c9` (`SUCCESS`)
- GitHub workflow: [verified-build 33314487171](https://github.com/RudraBhaskar9439/veritas/actions/runs/33314487171) (`SUCCESS`)
- Migration execution: `veritas-preview-migrations-h4msm` (`Completed`)
...
|---|---|---|
| API | `veritas-preview-api-00044-772` | `sha256:f1c7824c15797ea318e468b209c82215565c349b4a02122b90522c29f9e2bdef` |
| Drive ingress | `veritas-preview-ingress-00043-sqw` | `sha256:f1c7824c15797ea318e468b209c82215565c349b4a02122b90522c29f9e2bdef` |
| Worker | `veritas-preview-worker-00043-rvw` | `sha256:f1c7824c15797ea318e468b209c82215565c349b4a02122b90522c29f9e2bdef` |
| Web | `veritas-preview-web-00027-6zd` | `sha256:3318e31fc148f8d3df31aafdd4196d88fe2c5c93d32abe8f9489eed3040a51a7` |
...
Release `582df1f` carries the durable human authority boundary for ambiguous customer email and exposes the contest-mandated `gemini-3.5-flash` decision as a judge-readable receipt with exact input scope, rationale, risk flags, checksum, and explicit authority limits. The private worker is configured for Vertex AI's supported `global` inference endpoint while stateful services remain in `us-central1`. Historical one-shot execution `veritas-preview-model-probe-hwgqd` ran the exact `GeminiReviewGateway` as the production worker service account and logged a schema-valid `proceed` result recognizing exactly `claim-1`; it exited zero. The temporary probe job was then deleted without weakening IAM, while its Cloud execution and logs remain. The complete twelve-phase local gate and GitHub workflow pass with 233 backend tests, 26 frontend tests, 90.06% coverage, 40/40 evaluation scenarios, and 5/5 deterministic rehearsals.
...
- Desktop hosted-browser semantics, refresh persistence, visible approvals, real-time incident updates, and overflow checks passed. The final 2026-08-30 audit confirmed that routed destinations open at the top, all seven execution-stage labels render without clipping at 1280px, and the Execution and Architecture views have no horizontal overflow. The 390×844 hosted phone audit shows mobile navigation, the complete seven-stage progression, and scroll width exactly equal to viewport width. The earlier full semantics audit had one `main`, one H1, zero unlabeled buttons, zero images without `alt`, one skip link, and one live region; keyboard-only Enter navigation successfully exposed the Blast radius and Verification views.
