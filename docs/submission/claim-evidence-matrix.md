...
| The system runs on Google Cloud | [`live-proof-report.md`](live-proof-report.md), Cloud Run revisions, image digests, Cloud SQL, Storage, Vertex AI, KMS, Logs | Hosted release evidence bound to accepted application release `582df1f`; historical Workspace certificates retain their original release IDs |
