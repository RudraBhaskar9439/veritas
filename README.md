...
3. Move through **Command center**, **Live run**, **Email → Task**, **Repair desk**, **Blast radius**, **Proof ledger**, **Verification**, and **Architecture** to inspect the complete registered 4% → 9% scenario.
